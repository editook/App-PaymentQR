package com.editoapp.qrpago.cache
...
import com.editoapp.qrpago.data.StoredQR
...
class AuthDataStore(private val context: Context) {
    ...
    companion object {
        ...
        private val LOGIN_KEY_ACCESS = stringPreferencesKey("login_key_access")
    ...
    val sessionFlow: Flow<StoredSession> = context.dataStore.data
        .map { preferences ->
            ...
            StoredSession(
                posNumber = preferences[LOGIN_POST] ?: "",
                keyAccess = preferences[LOGIN_KEY_ACCESS] ?: "",
                majorNumber = preferences[LOGIN_MAJOR] ?: "",
    ...
    suspend fun saveLoginKey(user: StoredSession) {
        context.dataStore.edit { preferences ->
            preferences[LOGIN_POST] = user.posNumber
            preferences[LOGIN_KEY_ACCESS] = user.keyAccess
            preferences[LOGIN_MAJOR] = user.majorNumber
    ...
    suspend fun clearLoginKey() {
        context.dataStore.edit { preferences ->
            ...
            preferences.remove(LOGIN_KEY_ACCESS)
